...
def is_id_exists(student_id) -> bool:
    for student in Student.all_students:
...
class Student:
    ...
    def generate_student_id(self) -> int:
        return len(self.all_students) + self.starting_student_id
    
    def __str__(self) -> str:
        print(f"Class Student: Student ID: {self.id}, first name: {self.first_name}")
    
    def __repr__(self) -> str:
        print(f"Student ID: {self.id}, first name: {self.first_name}")
